...
public:
    ...
    void                            SetColor(float pRed, float pGreen, float pBlue, float pAlpha=1.0f) { Corner1SetColor(pRed, pGreen, pBlue, pAlpha); Corner2SetColor(pRed, pGreen, pBlue, pAlpha); Corner3SetColor(pRed, pGreen, pBlue, pAlpha); Corner4SetColor(pRed, pGreen, pBlue, pAlpha); }
    ...
    inline void                     Corner1SetPos(float pX, float pY) { Corner1SetPos(pX, pY, 0.0f); }
    ...
    inline void                     Corner2SetPos(float pX, float pY) { Corner2SetPos(pX, pY, 0.0f); }
    ...
    inline void                     Corner3SetPos(float pX, float pY) { Corner3SetPos(pX, pY, 0.0f); }
    ...
    inline void                     Corner4SetPos(float pX, float pY) { Corner4SetPos(pX, pY, 0.0f); }
